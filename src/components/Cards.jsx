    ...
    return (
        <div>
            ...
            >
                <SwiperSlide className='bg-white border'>
                    <div class="rounded overflow-hidden shadow-lg dark:shadow-gray-800">
                        <img
                            ...
                            alt="Mountain" />
                        <div class="px-6 py-4">
                            <div class="font-bold text-xl mb-2">Community</div>
                ...
                <SwiperSlide className='bg-white border'> <div class="rounded overflow-hidden shadow-lg dark:shadow-gray-800">
                    <img
                        class="w-full"
                        src={ChatBot}
                        alt="Mountain" />
                ...
                <SwiperSlide className='bg-white border'> <div class="rounded overflow-hidden shadow-lg dark:shadow-gray-800">
                    <img
                        ...
                        alt="Mountain" />
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2">Veterinary</div>
                        <p class="text-gray-700 dark:text-gray-300 text-base">
